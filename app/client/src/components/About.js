          ...
          <div id="about" className="container">
            <div className="row align-items-center mr-auto">
              <div className="col-md-4">
                ...
                <p className="Recents_card__title__rDmoN"><strong><u className="text-red-500">ScentLy</u> is the go-to place for keeping up to date with the latest trends in 
              ...
              <div className="col-sm-6 col-md-4 ml-auto">
                        <div className="widget">
                            ...
                            <div className="infos-wrapper">
                                ...
                                <p className="text-secondary Recents_card__title__rDmoN"><strong>Total Users</strong></p>
                            </div>
                        </div>
                        <div className="widget">
                            <div className="icon-wrapper">
                            ...
                            <div className="infos-wrapper">
                                ...
                                <p className="text-secondary Recents_card__title__rDmoN"><strong>Total Reviews</strong></p>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-6 col-md-4">
                        <div className="widget">
                            ...
                            <div className="infos-wrapper">
                                ...
                                <p className="text-secondary Recents_card__title__rDmoN"><strong>Total fragrances</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
