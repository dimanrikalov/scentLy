export default function Register () {
    ...
    // register form fcks up all other css
    return (
<div>
            ...
            <div className="mt-12 flex flex-col items-center">
              ...
              <div className="w-full flex-1 mt-8">
                ...
                <div className="mx-auto max-w-xs">
                  ...
                  <input className="w-full px-8 py-4 rounded-2xl font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5" type="repeatPassword" placeholder="Confirm Password" />
