...
export default function ReviewCard({reviewData}) {
    return (
          <div className={styles.card}>
            <img src={`../../assets/imgs/rating-${Math.round(reviewData.rating)}.png`} className={styles.card__image} alt="rating-image" />
            <div className={styles.card__overlay}>
              <div className={styles.card__header}>
                <svg className={styles.card__arc} xmlns="http://www.w3.org/2000/svg"><path /></svg>                     
                <img className={styles.card__thumb} src={reviewData.authorImageUrl} alt="author-image" />
